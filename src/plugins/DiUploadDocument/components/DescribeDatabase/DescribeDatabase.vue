  ...
  <div>
      ...
      <div class="col-12">
        <div class="describe-db mx-auto">
          <div class="form-group">
            ...
            <div class="dropdown">
              <button class="btn btn-di-default w-100 dropdown-toggle" data-toggle="dropdown">
            ...
            <input v-if="database.createNew" v-model="database.createNewModel" ref="newDatabase" type="text" class="form-control mt-3" placeholder="Input name new database">
          </div>
          <div class="form-group">
            <label>Select or create new table</label>
            <div class="dropdown">
              <button :disabled="!database.model" class="btn btn-di-default w-100 dropdown-toggle" data-toggle="dropdown">
            ...
            <input v-if="table.createNew" v-model="table.createNewModel" ref="newTable"  type="text" class="form-control mt-3" placeholder="Input name new database">
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-12 text-right">
        ...
        <button @click.prevent="register" class="btn btn-di-primary">Next</button>
      </div>
    </div>
  </div>
</template>
